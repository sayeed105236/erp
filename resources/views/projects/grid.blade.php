                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-0 mt-3">
                            <div class="card-body p-3">
                                ...
                                @can('edit project')
                                    <a class="btn btn-primary" href="#!" data-size="lg" data-url="{{ route('projects.edit', $project->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Accept Project')}}">

                                        <span>{{__('Accept')}}</span>
                                    </a>
                                @endcan
                                @can('edit project')
                                <a class="btn btn-danger" href="#!" data-size="lg" data-url="{{ route('projects.deny', $project->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Deny Project')}}">
