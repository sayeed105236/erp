...
@section('action-btn')
    ...
    <div class="float-end">
        ...
        <div class="col-auto">
            ...
            @can('create deal')
            <a href="#" data-size="lg" data-url="{{ route('deals.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Required info for project manager')}}" class="btn btn-sm btn-primary">
                                ...
                                @foreach($deals as $deal)
                                    <div class="card" data-id="{{$deal->id}}">
                                        ...
                                        <div class="card-header border-0 pb-0 position-relative">
                                            <h5><a href="@can('view lead')@if($deal->is_active){{route('deals.show',$deal->id)}}@else#@endif @else#@endcan">{{$deal->name}}</a></h5>
