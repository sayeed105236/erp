    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <?php echo Form::select('client', $clients, null,array('class' => 'form-control select2','id'=>'choices-multiple1','required'=>'required')); ?>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <?php echo Form::select('user[]', $users, null,array('class' => 'form-control select2','id'=>'choices-multiple2','required'=>'required')); ?>
...
<?php /**PATH D:\Sayeed_Laravel_Developer\laragon\www\seopage1_erp\resources\views/projects/create.blade.php ENDPATH**/ ?>