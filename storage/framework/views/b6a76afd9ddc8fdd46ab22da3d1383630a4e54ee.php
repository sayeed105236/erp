                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-0 mt-3">
                            <div class="card-body p-3">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                                    <a class="btn btn-primary" href="#!" data-size="lg" data-url="<?php echo e(route('projects.edit', $project->id)); ?>" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="<?php echo e(__('Accept Project')); ?>">

                                        <span><?php echo e(__('Accept')); ?></span>
                                    </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                                <a class="btn btn-danger" href="#!" data-size="lg" data-url="<?php echo e(route('projects.deny', $project->id)); ?>" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="<?php echo e(__('Deny Project')); ?>">

                                    <span><?php echo e(__('Deny')); ?></span>
                                </a>
...
<?php endif; ?>
<?php /**PATH D:\Sayeed_Laravel_Developer\laragon\www\seopage1_erp\resources\views/projects/grid.blade.php ENDPATH**/ ?>